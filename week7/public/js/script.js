...
socket.on('number', (msg) => {
  console.log('Students Online (Random number from server for demo purpose):', msg);
  $('#numberDisplay').text(msg);
});

socket.on('new-user', (msg) => {
  console.log(msg)
  M.toast({ html: msg, classes: 'rounded blue lighten-1 white-text' });
});
